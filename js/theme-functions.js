    ...
    INSPIRO.loader = function () {
        ...
        if (!$body.hasClass('no-page-loader')) {
            ...
            var pageInAnimation = $body.attr('data-animation-in') || "fadeIn",
                ...
                pageLoaderStylePath = $body.attr('data-animation-icon-path') || "img/",
    ...
    INSPIRO.maps = function () {
        ...
        if ($map.exists()) {
            ...
            $map.each(function () {
                ...
                var $elem = $(this),
                    mapAddress = $elem.attr('data-map-address') ? $elem.attr('data-map-address') : "Lagos, Nigeria",
        ...
        setTimeout(function () {
                if ($widget_twitter.length > 0) {
                    $widget_twitter.each(function () {
                        var $elem = $(this),
                            twitterUsername = $elem.attr('data-username') || "tournigeriang",
                            twitterLimit = $elem.attr('data-limit') || 2,
                            twitterDateFormat = $elem.attr('data-format') || ' %d/%b/%Y',
